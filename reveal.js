...
! function (e, t) {
    ...
    var rt = function (e) {
        ...
        st = function (e) {
            ...
            return function (s, l, u, c) {
                for (var d, h, f = De(s), g = v(f), p = at(l, u, 3), m = de(g.length), y = 0, b = c || _e, w = t ? b(s, m) : n ? b(s, 0) : void 0; m > y; y++)
    ...
    var St = Object.keys || function (e) {
        ...
        At = !Et || a((function () {
            ...
            for (var n = De(e), i = arguments.length, r = 1, a = Ee.f, s = u.f; i > r;)
                for (var l, c = v(arguments[r++]), d = a ? St(c).concat(a(c)) : St(c), h = d.length, f = 0; h > f;) l = d[f++], o && !s.call(c, l) || (n[l] = c[l]);
            return n
        } : Et;
    Oe({
        target: "Object",
    ...
    Oe({
        ...
        from: function (e) {
            ...
            if (d && (c = at(c, u > 2 ? arguments[2] : void 0, 2)), null == h || l == Array && Mn(h))
                ...
                for (a = (r = h.call(s)).next, n = new l; !(i = a.call(r)).done; f++) o = d ? Ln(r, c, [i.value, f], !0) : i.value, je(n, f, o);
            return n.length = f, n
        }
    });
    var Vn = pe.indexOf,
    ...
    var la, ua, ca, da = function (e) {
        ...
        va = K("IE_PROTO"),
        ga = Object.prototype,
        pa = fa ? Object.getPrototypeOf : function (e) {
    ...
    Fa("split", 2, (function (e, t, n) {
        ...
        return i = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (e, n) {
            var i, r, a = String(g(this)),
                o = void 0 === n ? Ka : n >>> 0;
            if (0 === o) return [];
            if (void 0 === e) return [a];
            if (!m(i = e) || !(void 0 !== (r = i[Wa]) ? r : "RegExp" == h(i))) return t.call(a, e, o);
            for (var s, l, u, c = [], d = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), f = 0, v = new RegExp(e.source, d + "g");
                (s = sa.call(v, a)) && !((l = v.lastIndex) > f && (c.push(a.slice(f, s.index)), s.length > 1 && s.index < a.length && _a.apply(c, s.slice(1)), u = s[0].length, f = l, c.length >= o));) v.lastIndex === s.index && v.lastIndex++;
                ...
                value: function (e) {
                    ...
                    e && !this.Reveal.isSpeakerNotes() && (So(e, 'img[src$=".gif"]').forEach((function (e) {
                        ...
                        if (!xo(e, ".fragment") || xo(e, ".fragment.visible")) {
                            ...
                            if ("boolean" != typeof n && (n = e.hasAttribute("data-autoplay") || !!xo(e, ".slide-background")), n && "function" == typeof e.play)
            ...
            return no(e, [{
                ...
                value: function () {
                    ...
                    if (!/^[0-9]*$/.test(r[0]) && a.length) {
                        ...
                        var c, d = e.hashOneBasedIndex ? 1 : 0,
    ...
    var xs = function () {
        ...
        Ls = {
            width: 1200, // originally 960
            height: 875, // originally 700
            margin: .00,
            minScale: .2,
            maxScale: 2,
            controls: !0,
    ...
    function Ps(e, t) {
            ...
            if (r && void 0 !== n) {
                ...
                for (var o = 0; o < r; o++) {
                    var s = t[o],
                        u = So(s, "section"),
                        c = u.length;
                    if (e = Math.abs((n || 0) - o) || 0, l.loop && (e = Math.abs(((n || 0) - o) % (r - a)) || 0), e < a ? w.load(s) : w.unload(s), c)
        ...
        function Qe() {
            ...
            if (!1 === A.prev())
                if (Ce().up) Ge();
                else if (e = l.rtl ? So(v.wrapper, ".slides>section.future").pop() : So(v.wrapper, ".slides>section.past").pop()) {
