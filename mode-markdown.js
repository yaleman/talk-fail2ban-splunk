            ...
            this.add("string_dquotes", "insertion", function (e, t, n, r, i) {
                ...
                if (i == ">") {
                    ...
                    if (u(f, "attribute-value")) {
                        ...
                        if (o.column == l) {
                            if (u(a.stepForward(), "attribute-value")) return;
                            a.stepBackward()
                        }
                    }
                    ...
                    var c = a.getCurrentTokenRow(),
                        h = a.getCurrentTokenColumn();
                    if (u(a.stepBackward(), "end-tag-open")) return;
                    var p = f.value;
                    c == o.row && (p = p.substring(0, o.column - h));
                    if (this.voidElements.hasOwnProperty(p.toLowerCase())) return;
                    return {
                        text: "></" + p + ">",
                        selection: [1, 1]
                    }
...
}), define("ace/mode/markdown_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules", "ace/mode/javascript_highlight_rules", "ace/mode/xml_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/css_highlight_rules"], function (e, t, n) {
    "use strict";
...
}), define("ace/mode/markdown", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/javascript", "ace/mode/xml", "ace/mode/html", "ace/mode/markdown_highlight_rules", "ace/mode/folding/markdown"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
        i = e("./text").Mode,
        s = e("./javascript").Mode,
