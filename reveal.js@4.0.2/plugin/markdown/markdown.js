! function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).RevealMarkdown = t()
}(this, (function () {
    "use strict";
    ...
    var P, I, C, L = z.inspectSource,
        ...
        U = Math.random(),
        Z = function (e) {
            return "Symbol(" + String(void 0 === e ? "" : e) + ")_" + (++q + U).toString(36)
        },
        F = D("keys"),
        G = function (e) {
            return F[e] || (F[e] = Z(e))
    ...
    var J, Q, ee = {
        ...
        te = t((function (e) {
            ...
            (e.exports = function (e, t, o, a) {
                var s = !!a && !!a.unsafe,
                    l = !!a && !!a.enumerable,
                    c = !!a && !!a.noTargetGet;
                "function" == typeof o && ("string" != typeof t || m(o, "name") || R(o, "name", t), n(o).source = i.join("string" == typeof t ? t : "")), e !== r ? (s ? !c && e[t] && (l = !0) : delete e[t], l ? e[t] = o : R(e, t, o)) : l ? e[t] = o : j(t, o)
        ...
        ze = function (e, t) {
            var n, i, o, a, s, l = e.target,
                c = e.global,
                u = e.stat;
            if (n = c ? r : u ? r[l] || j(l, {}) : (r[l] || {}).prototype)
                for (i in t) {
                    if (a = t[i], o = e.noTargetGet ? (s = je(n, i)) && s.value : n[i], !Re(c ? i : l + (u ? "." : "#") + i, e.forced) && void 0 !== o) {
        ...
        Me = D("wks"),
        Ne = r.Symbol,
        De = Le ? Ne : Ne && Ne.withoutSetter || Z,
        qe = function (e) {
            return m(Me, e) || (Ce && m(Ne, e) ? Me[e] = Ne[e] : Me[e] = De("Symbol." + e)), Me[e]
        },
        Ue = qe("species"),
        Ze = function (e, t) {
            var n;
    ...
    ze({
        ...
        concat: function (e) {
            var t, n, r, i, o, a = Pe(this),
                s = Ze(a, 0),
                l = 0;
            for (t = -1, r = arguments.length; t < r; t++)
                if (o = -1 === t ? a : arguments[t], Qe(o)) {
                    if (l + (i = ce(o.length)) > 9007199254740991) throw TypeError("Maximum allowed index exceeded");
                    for (n = 0; n < i; n++, l++) n in o && Ie(s, l, o[n])
                } else {
    ...
    var et = function (e) {
        ...
        rt = function (e) {
            ...
            return function (s, l, c, u) {
                for (var f, h, g = Pe(s), d = p(g), v = tt(l, c, 3), y = ce(d.length), b = 0, m = u || Ze, k = t ? m(s, y) : n ? m(s, 0) : void 0; y > b; b++)
        ...
        ct = function (e, t) {
            if (m(st, e)) return st[e];
            t || (t = {});
            var n = [][e],
                r = !!m(t, "ACCESSORS") && t.ACCESSORS,
                a = m(t, 0) ? t[0] : lt,
                s = m(t, 1) ? t[1] : void 0;
            return st[e] = !!n && !i((function () {
                if (r && !o) return !0;
                var e = {
                    length: -1
                };
    ...
    var gt, dt = Object.keys || function (e) {
            return ve(e, ye)
        },
    ...
    var Lt = {
        ...
        Bt = function (e, t, n, r, i, o, a) {
            ...
            if (y && (s = Pt(y.call(new e)), Ft !== Object.prototype && s.next && (Pt(s) !== Ft && (Zt ? Zt(s, Ft) : "function" != typeof s[Ht] && R(s, Ht, Wt)), Dt(s, h, !0))), "values" == i && d && "values" !== d.name && (p = !0, v = function () {
                    return d.call(this)
                }), g[Ht] !== v && R(g, Ht, v), Rt[t] = v, i)
                if (l = {
                        values: f("values"),
                        keys: o ? v : f("keys"),
                        entries: f("entries")
                    }, a)
                    for (u in l)(Gt || p || !(u in g)) && te(g, u, l[u]);
                else ze({
                    target: t,
                    proto: !0,
                    forced: Gt || p
    ...
    ze({
        ...
        slice: function (e, t) {
            var n, r, i, o = d(this),
                ...
                s = he(e, a),
                l = he(void 0 === t ? a : t, a);
            if ($e(o) && ("function" != typeof (n = o.constructor) || n !== Array && !$e(n.prototype) ? v(n) && null === (n = n[nn]) && (n = void 0) : n = void 0, n === Array || void 0 === n)) return rn.call(o, s, l);
            for (r = new(void 0 === n ? Array : n)(on(l - s, 0)), i = 0; s < l; s++, i++) s in o && Ie(r, i, o[s]);
            return r.length = i, r
        }
    });
    var an = O.f,
        ...
        ln = sn.toString,
        cn = /^\s*function ([^ (]*)/;
    o && !("name" in sn) && an(sn, "name", {
        configurable: !0,
        get: function () {
            try {
                return ln.call(this).match(cn)[1]
            } catch (e) {
                return ""
            }
        }
    ...
    var Wn, Bn, Vn, Kn, Xn, Yn, Jn, Qn, er = {
            set: Cn,
            clear: Ln
        },
        tr = E.f,
    ...
    var cr, ur, fr, hr, pr = lr || function (e) {
            var t = {
                fn: e,
                next: void 0
            };
                ...
                pr((function () {
                    for (var i = t.value, o = 1 == t.state, a = 0; r.length > a;) {
                        var s, l, c, u = r[a++],
                            ...
                            g = u.domain;
                        try {
                            f ? (o || (2 === t.rejection && qr(e, t), t.rejection = 1), !0 === f ? s = i : (g && g.enter(), s = f(i), g && (g.exit(), c = !0)), s === u.promise ? p(Er("Promise-chain cycle")) : (l = Cr(s)) ? l.call(s, h, p) : h(s)) : p(i)
                        } catch (e) {
                            g && !c && g.exit(), p(e)
                        }
                    }
        ...
        Nr = function (e, t) {
            br.call(r, (function () {
                var n, r = t.value;
                if (Dr(t) && (n = yr((function () {
                        zr ? Tr.emit("unhandledRejection", r, e) : Mr("unhandledrejection", e, r)
                    })), t.rejection = zr || Dr(t) ? 2 : 1, n.error)) throw n.value
            }))
        },
        Dr = function (e) {
    ...
    if (o && Re("RegExp", !ri || ii || i((function () {
        ...
        for (var oi = function (e, t) {
                ...
                var a, s, l, c, u, f = (a = ri ? new Qr(e, t) : Qr(e, t), s = r ? this : ei, l = oi, Zt && "function" == typeof (c = s.constructor) && c !== l && v(u = c.prototype) && u !== l.prototype && Zt(a, u), a);
                return ii && n && Yr(f, {
                    sticky: n
                }), f
            }, ai = function (e) {
            ...
            }, si = Xr(Qr), li = 0; si.length > li;) ai(si[li++]);
    ...
    (hi || gi || pi) && (fi = function (e) {
        var t, n, r, i, o = this,
            ...
            c = 0,
            u = e;
        return a && (-1 === (s = s.replace("y", "")).indexOf("g") && (s += "g"), u = String(e).slice(o.lastIndex), o.lastIndex > 0 && (!o.multiline || o.multiline && "\n" !== e[o.lastIndex - 1]) && (l = "(?: " + l + ")", u = " " + u, c++), n = new RegExp("^(?:" + l + ")", s)), gi && (n = new RegExp("^" + l + "$(?!\\s)", s)), hi && (t = o.lastIndex), r = ci.call(a ? n : o, u), a ? r ? (r.input = r.input.slice(c), r[0] = r[0].slice(c), r.index = o.lastIndex, o.lastIndex += r[0].length) : o.lastIndex = 0 : hi && r && (o.lastIndex = o.global ? r.index + r[0].length : t), gi && r && r.length > 1 && ui.call(r[0], n, (function () {
    ...
    var Ei = qe("species"),
        ...
        zi = function (e, t, n, r) {
            ...
            if (!a || !s || "replace" === e && (!Ai || !Ti || Ri) || "split" === e && !ji) {
                var l = /./ [o],
    ...
    zi("match", 1, (function (e, t, n) {
        return [function (t) {
            ...
            var a = i.unicode;
            i.lastIndex = 0;
            for (var s, l = [], c = 0; null !== (s = Ii(i, o));) {
                var u = String(s[0]);
                l[c] = u, "" === u && (i.lastIndex = Pi(o, ce(i.lastIndex), a)), c++
            }
            return 0 === c ? null : l
        }]
    }));
    ...
    zi("replace", 2, (function (e, t, n, r) {
        ...
        return [function (n, r) {
            ...
            for (var v, y = "", b = 0, m = 0; m < g.length; m++) {
                d = g[m];
                for (var k = String(d[0]), x = Ci(Li(se(d.index), u.length), 0), w = [], S = 1; S < d.length; S++) w.push(void 0 === (v = d[S]) ? v : String(v));
                var _ = d.groups;
                if (f) {
                    var E = [k].concat(w, x, u);
                    void 0 !== _ && E.push(_);
                    var T = String(r.apply(void 0, E))
                } else T = s(k, u, x, w, _, r);
            ...
            return void 0 !== o && (o = Pe(o), c = Ni), t.call(a, c, (function (t, a) {
                ...
                switch (a.charAt(0)) {
                    ...
                    default:
                        ...
                        if (u > l) {
                            var f = Mi(u / 10);
                            return 0 === f ? t : f <= l ? void 0 === i[f - 1] ? a.charAt(1) : i[f - 1] + a.charAt(1) : t
                        }
                        c = i[u - 1]
                }
                return void 0 === c ? "" : c
    ...
    zi("split", 2, (function (e, t, n) {
        ...
        return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (e, n) {
            ...
            for (var o, a, s, l = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, f = new RegExp(e.source, c + "g");
                (o = di.call(f, r)) && !((a = f.lastIndex) > u && (l.push(r.slice(u, o.index)), o.length > 1 && o.index < r.length && qi.apply(l, o.slice(1)), s = o[0].length, u = a, l.length >= i));) f.lastIndex === o.index && f.lastIndex++;
            ...
            var a = A(e),
                ...
                f = new l(Zi ? a : "^(?:" + a.source + ")", u),
                h = void 0 === i ? 4294967295 : i >>> 0;
            if (0 === h) return [];
            if (0 === s.length) return null === Ii(f, s) ? [s] : [];
            for (var p = 0, g = 0, d = []; g < s.length;) {
                f.lastIndex = Zi ? g : 0;
                var v, y = Ii(f, Zi ? s : s.slice(g));
                if (null === y || (v = Ui(ce(f.lastIndex + (Zi ? 0 : g)), s.length)) === p) g = Pi(s, g, c);
                else {
                    if (d.push(s.slice(p, g)), d.length === h) return d;
                    for (var b = 1; b <= y.length - 1; b++)
                        if (d.push(y[b]), d.length === h) return d;
                    g = p = v
                }
            }
            return d.push(s.slice(p)), d
        }]
    }), !Zi);
    var Fi = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        Gi = "[" + Fi + "]",
    ...
    var Go = t((function (e) {
        ...
        Ho = (Go.defaults, Go.getDefaults, Go.changeDefaults, Ke("splice")),
        Wo = ct("splice", {
            ACCESSORS: !0,
            0: 0,
            1: 2
    ...
    ze({
        ...
        splice: function (e, t) {
            var n, r, i, o, a, s, l = Pe(this),
                c = ce(l.length),
                u = he(e, c),
                f = arguments.length;
            if (0 === f ? n = r = 0 : 1 === f ? (n = 0, r = c - u) : (n = f - 2, r = Vo(Bo(se(t), 0), c - u)), c + n - r > 9007199254740991) throw TypeError("Maximum allowed length exceeded");
            for (i = Ze(l, r), o = 0; o < r; o++)(a = u + o) in l && Ie(i, o, l[a]);
            if (i.length = r, n < r) {
                for (o = u; o < c - r; o++) s = o + n, (a = o + r) in l ? l[s] = l[a] : delete l[s];
                for (o = c; o > c - r + n; o--) delete l[o - 1]
            } else if (n > r)
                for (o = c - r; o > u; o--) s = o + n - 1, (a = o + r - 1) in l ? l[s] = l[a] : delete l[s];
    ...
    function ua(e, t) {
        aa[" " + e] || (sa.test(e) ? aa[" " + e] = e + "/" : aa[" " + e] = fa(e, "/", !0));
        var n = -1 === (e = aa[" " + e]).indexOf(":");
        return "//" === t.substring(0, 2) ? n ? t : e.replace(la, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace(ca, "$1") + t : e + t
    }
    ...
    var Oa = function () {
            ...
            return uo(e, [{
                ...
                value: function (e) {
                    ...
                    if (t) {
                        for (var n, r, i, o, a, s, l, c = t[0], u = t[2], f = u.length > 1, h = {
                                type: "list",
                                raw: c,
                                ordered: f,
                                start: f ? +u : "",
    ...
    var qa = function () {
            function e(t) {
                lo(this, e), this.tokens = [], this.tokens.links = Object.create(null), this.options = t || Ca, this.options.tokenizer = this.options.tokenizer || new Oa, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options;
                var n = {
                    block: La.normal,
                    inline: Ma.normal
                };
            ...
            return uo(e, [{
                ...
                value: function (e) {
                    ...
                    for (e = e.replace(/^ +$/gm, ""); e;)
                        ...
                        else if (t = this.tokenizer.code(e, o)) e = e.substring(t.raw.length), t.type ? o.push(t) : ((i = o[o.length - 1]).raw += "\n" + t.raw, i.text += "\n" + t.text);
                    ...
                    else if (t = this.tokenizer.text(e, o)) e = e.substring(t.raw.length), t.type ? o.push(t) : ((i = o[o.length - 1]).raw += "\n" + t.raw, i.text += "\n" + t.text);
                    else if (e) {
                ...
                key: "inlineTokens",
                value: function (e) {
                    for (var t, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]; e;)
                        if (t = this.tokenizer.escape(e)) e = e.substring(t.raw.length), n.push(t);
                        else if (t = this.tokenizer.tag(e, r, i)) e = e.substring(t.raw.length), r = t.inLink, i = t.inRawBlock, n.push(t);
                    else if (t = this.tokenizer.link(e)) e = e.substring(t.raw.length), "link" === t.type && (t.tokens = this.inlineTokens(t.text, [], !0, i)), n.push(t);
                    else if (t = this.tokenizer.reflink(e, this.tokens.links)) e = e.substring(t.raw.length), "link" === t.type && (t.tokens = this.inlineTokens(t.text, [], !0, i)), n.push(t);
                    else if (t = this.tokenizer.strong(e)) e = e.substring(t.raw.length), t.tokens = this.inlineTokens(t.text, [], r, i), n.push(t);
                    else if (t = this.tokenizer.em(e)) e = e.substring(t.raw.length), t.tokens = this.inlineTokens(t.text, [], r, i), n.push(t);
                    ...
                    else if (t = this.tokenizer.del(e)) e = e.substring(t.raw.length), t.tokens = this.inlineTokens(t.text, [], r, i), n.push(t);
                    else if (t = this.tokenizer.autolink(e, Da)) e = e.substring(t.raw.length), n.push(t);
                    else if (r || !(t = this.tokenizer.url(e, Da))) {
        ...
        Ka = function () {
            function e(t) {
                lo(this, e), this.options = t || Ba, this.options.renderer = this.options.renderer || new Ga, this.renderer = this.options.renderer, this.renderer.options = this.options, this.textRenderer = new Ha, this.slugger = new Wa
            }
            return uo(e, [{
                key: "parse",
                value: function (e) {
                    var t, n, r, i, o, a, s, l, c, u, f, h, p, g, d, v, y, b, m = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                        k = "",
                        x = e.length;
                    for (t = 0; t < x; t++) switch ((u = e[t]).type) {
                        ...
                        case "code":
                            ...
                            continue;
                        case "table":
                            for (l = "", s = "", i = u.header.length, n = 0; n < i; n++) s += this.renderer.tablecell(this.parseInline(u.tokens.header[n]), {
                                header: !0,
                                align: u.align[n]
                            });
        ...
        Ja = ha,
        Qa = Go.getDefaults,
        es = Go.changeDefaults,
        ts = Go.defaults;

    function ns(e, t, n) {
        if (null == e) throw new Error("marked(): input parameter is undefined or null");
        if ("string" != typeof e) throw new Error("marked(): input parameter is of type " + Object.prototype.toString.call(e) + ", string expected");
        if ("function" == typeof t && (n = t, t = null), t = Xa({}, ns.defaults, t || {}), Ya(t), n) {
            var r, i = t.highlight;
            try {
                r = qa.lex(e, t)
            } catch (e) {
            ...
            var a = 0;
            return ns.walkTokens(r, (function (e) {
        ...
        try {
            var s = qa.lex(e, t);
            return t.walkTokens && ns.walkTokens(s, t.walkTokens), Ka.parse(s, t)
        } catch (e) {
            if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", t.silent) return "<p>An error occurred:</p><pre>" + Ja(e.message + "", !0) + "</pre>";
            throw e
        }
    }
    ns.options = ns.setOptions = function (e) {
        return Xa(ns.defaults, e), es(ns.defaults), ns
    }, ns.getDefaults = Qa, ns.defaults = ts, ns.use = function (e) {
        var t = Xa({}, e);
        if (e.renderer && function () {
                var n = ns.defaults.renderer || new Ga,
                    r = function (t) {
                        var r = n[t];
                        n[t] = function () {
                ...
                var n = ns.defaults.tokenizer || new Oa,
                    r = function (t) {
                        var r = n[t];
                        n[t] = function () {
                            for (var i = arguments.length, o = new Array(i), a = 0; a < i; a++) o[a] = arguments[a];
            ...
            var n = ns.defaults.walkTokens;
            t.walkTokens = function (t) {
                e.walkTokens(t), n && n(t)
            }
        }
        ns.setOptions(t)
    }, ns.walkTokens = function (e, t) {
        var n, r = yo(e);
        try {
            for (r.s(); !(n = r.n()).done;) {
                var i = n.value;
                switch (t(i), i.type) {
                    case "table":
                        ...
                        break;
                    case "list":
                        ns.walkTokens(i.items, t);
                        break;
                    default:
                        i.tokens && ns.walkTokens(i.tokens, t)
                }
            }
        } catch (e) {
            r.e(e)
    ...
    }, ns.Parser = Ka, ns.parser = Ka.parse, ns.Renderer = Ga, ns.TextRenderer = Ha, ns.Lexer = qa, ns.lexer = qa.lex, ns.Tokenizer = Oa, ns.Slugger = Wa, ns.parse = ns;
    var rs = ns,
        is = /\[([\s\d,|-]*)\]/;
    return function () {
        var e;
        ...
        function i(e, t) {
            ...
            return 2 === n.length && (e = n[0] + '<aside class="notes">' + rs(n[1].trim()) + "</aside>"), '<script type="text/template">' + (e = e.replace(/<\/script>/g, "__SCRIPT_END__")) + "<\/script>"
        }

        function o(e, t) {
            t = r(t);
            for (var n, o, a, s = new RegExp(t.separator + (t.verticalSeparator ? "|" + t.verticalSeparator : ""), "mg"), l = new RegExp(t.separator), c = 0, u = !0, f = []; n = s.exec(e);) !(o = l.test(n[0])) && u && f.push([]), a = e.substring(c, n.index), o && u ? f.push(a) : f[f.length - 1].push(a), c = s.lastIndex, u = o;
        ...
        function processSlidesInternal(e) {
        ...
        function s(e, t, n) {
            var r, i, o = new RegExp(n, "mg"),
                a = new RegExp('([^"= ]+?)="([^"]+?)"|(data-[^"= ]+?)(?=[" ])', "mg"),
                s = e.nodeValue;
            if (r = o.exec(s)) {
                var l = r[1];
                for (s = s.substring(0, r.index) + s.substring(o.lastIndex), e.nodeValue = s; i = a.exec(l);) i[2] ? t.setAttribute(i[1], i[2]) : t.setAttribute(i[3], "");
                return !0
            }
            return !1
        }

        function convertSlidesInternal() {
                ...
                e.innerHTML = rs(r),
                    function e(t, n, r, i, o) {
                        if (null != n && null != n.childNodes && n.childNodes.length > 0)
                            for (var a = n, l = 0; l < n.childNodes.length; l++) {
                                var c = n.childNodes[l];
                                if (l > 0)
                                    for (var u = l - 1; u >= 0;) {
                        ...
                        n.nodeType == Node.COMMENT_NODE && 0 == s(n, r, i) && s(n, t, o)
        ...
        return {
            ...
            init: function (t) {
                e = t;
                var n = new rs.Renderer;
                return n.code = function (e, t) {
                    var n = "";
                    return is.test(t) && (n = t.match(is)[1].trim(), n = 'data-line-numbers="'.concat(n, '"'), t = t.replace(is, "").trim()), "<pre><code ".concat(n, ' class="').concat(t, '">').concat(e, "</code></pre>")
                }, rs.setOptions(function (e) {
                    ...
                    renderer: n
                }, e.getConfig().markdown)), processSlidesInternal(e.getRevealElement()).then(convertSlidesInternal)
            },
            processSlides: processSlidesInternal,
            convertSlides: convertSlidesInternal,
            slidify: o,
            marked: rs
        }
    }
